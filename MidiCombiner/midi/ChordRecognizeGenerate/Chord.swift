...
public enum Inversion : Int { case none,first,second,third }
public enum Form : Int { case short,long }
...
public class Chord : NSObject, NSSecureCoding
{
    public static var supportsSecureCoding = true
    
    public var additions = [Tone]()
    public var factors = [Tone]()
    public var ommission : Degree?
    public var quality : Quality = Quality.Maj
    public var factorQuality : Quality = Quality.dom
    public var notes : [ChordNote]!
    public var invertedNotes : [ChordNote]!
    public var alteredNotes = [Tone]()
    public weak var triad : Triad!
    public var octave : UInt8 = 0
    public var inversion : Inversion = Inversion.none
    ...
    public init(notes:[ChordNote])
    {
        self.notes = notes
        self.invertedNotes = [ChordNote]()
    }
    
    public init(root : ChordRoot,octave : UInt8, quality : Quality,factor : Degree, factorQuality : Quality)
    {
        super.init()
    ...
    public init(rootNote : ChordNote,quality : Quality,factor : Degree, factorQuality : Quality)
    {
        super.init()
    ...
    public func addAdditions(designators: [Tone])
    {
        additions.append(contentsOf: designators)
    }
    
    public func addFactors(factors: [Tone])
    {
        self.factors.append(contentsOf: factors)
    }
    
    public func setFactor(degree: Degree)
    {
        clearFactors()
    ...
    public func getFullName(formType : Form) -> String
    {
    ...
    public func getRootName() -> String
    {
    ...
    public func addNotesFromOffsets(offsets : [NoteRootOffset])
    {
        offsets.forEach({
    ...
    public func add(notesToAdd : [ChordNote])
    {
